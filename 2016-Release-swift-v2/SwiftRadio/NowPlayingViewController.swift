...
class NowPlayingViewController: UIViewController {
    ...
    @IBAction func openFB(sender: AnyObject) {
        ...
        let urlString = NSURL(string: "https://www.facebook.com/KultFM.hu")
    ...
    override func viewDidLoad() {
        ...
        currentStation = RadioStation(
            name: "KultFM",
            streamURL: "http://stream.kultfm.hu:8000/kultfm",
            imageURL: "kult_on_air2_128.png",
            desc: "",
            longDesc: ""
        )
    ...
    @IBAction func pausePressed() {
        ...
        radioPlayer.pause()
        updateLabels("Adás szüneteltetve...")
